    ...
    <article className="group flex flex-col rounded-2xl border border-vaibee-border bg-vaibee-card p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-vaibee-cyan/35 hover:shadow-md">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h2 className="mt-1 text-lg font-semibold text-vaibee-navy">{agent.name}</h2>
        </div>
      ...
      <div className="mt-5 flex gap-2">
        ...
        <button
          type="button"
          className="flex-1 rounded-xl bg-vaibee-navy px-3 py-2 text-sm font-semibold text-white transition hover:bg-vaibee-navy-soft"
        >
          Add to hive
        </button>
      </div>
