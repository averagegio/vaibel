...
export function LandingIntroHero() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-auto absolute inset-x-0 bottom-0 z-10 flex flex-col items-center px-4 pb-[max(2.5rem,env(safe-area-inset-bottom))] pt-16 text-center sm:pb-10">
